...
history:
  - version: 0.8.0
    date: 2026-04-24
    changes: Added `SCN-221` to the EP-008 and EP-022 overlays so the shared control-plane observability-event verifier anchor is discoverable by epic navigation.
  - version: 0.7.0
    date: 2026-04-24
...
- `EP-008 Scenarios And Verification`
  - current anchors: [SCN-001](../SCN-001-typed-sdk-parity.md), [SCN-012](../SCN-012-scenario-auth-bootstrap.md), [SCN-041](../SCN-041-verdict-export-stability-and-provenance.md), [SCN-168](../SCN-168-openai-runtime-provider-registration-and-readiness-projection.md), [SCN-170](../SCN-170-cross-provider-fail-fast-on-schema-or-prompt-error.md), [SCN-175](../SCN-175-explicit-model-policy-and-config-resolution-diagnostics-without-silent-fallback.md), [SCN-176](../SCN-176-shared-control-plane-channel-binding-and-readback-contract.md), [SCN-177](../SCN-177-shared-governed-content-import-readback-contract.md), [SCN-178](../SCN-178-shared-control-plane-execution-run-and-trace-artifact-readback-contract.md), [SCN-221](../SCN-221-shared-control-plane-observability-event-evidence-contract.md), [Scenario matrix](../scenario-matrix.md), [Verification matrix](../../plans/verification-matrix.md), `spec/scenarios/*`
