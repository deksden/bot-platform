...
| `command-framework` | `spec/runtime/command-framework-contract.md`, `spec/runtime/index.md` | `packages/core` (`@dd-bot-platform/core`, `packages/core/src/command-framework`) | [Scenario matrix](../scenarios/scenario-matrix.md) + `scenarios/contracts/index.md` | first typed command-framework implementation is landed with deterministic registry/availability/dispatch tests; concrete Docoved/SellerAgent command adoption and hosted scenarios remain product-side follow-up work |
